<template>
  ...
  <!-- Issues! -->
  <info-toast v-if="issuesToast" title="README!" :content="[['祈愿模拟器处于早期开发阶段','若发现问题请按下F12截图控制台','并联系作者邮箱:','yrchashao@foxmail.com'],['F12 -> 应用程序 -> 本地存储 -> goldRate 项','改为1000可开启解压模式(，默认为6'],['喜报：','自动跳过的bug不打算修啦！']]" :buttonInfo="[{content: '知道啦',event: 'window.location.reload()'}]"/>
  <!-- 投喂 -->
  ...
  <div class="content" v-if="homePage">
    ...
    <div class="footer">
      <div class="smallButtons">
        ...
        <p @click="playSound('button_press');issuesToast =! issuesToast">README</p>
      </div>
